 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "# Intelligent Approach - Night Classifier"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     ...
     "text": [
      "Iter: 0\n",
      "Class name: Pari Salai ; No. of Images: 2\n",
      "Predicted as:  Pari Salai,  Pari Salai, \n",
      "Groundtruth: Pari Salai\n",
      "Accuracy: 1.0\n",
      "\n",
      "Iter: 1\n",
      "Class name: Mogappair East ; No. of Images: 2\n",
      "Predicted as:  Mogappair East,  Mogappair East, \n",
      "Groundtruth: Mogappair East\n",
      "Accuracy: 1.0\n",
      "\n",
      "Iter: 2\n",
      "Class name: Pari Salai ; No. of Images: 2\n",
      ...
      "\n",
      "Iter: 4\n",
      "Class name: Medavakkam ; No. of Images: 2\n",
      "Predicted as:  Medavakkam,  Medavakkam, \n",
      "Groundtruth: Medavakkam\n",
      "Accuracy: 1.0\n",
      "\n",
      "Iter: 5\n",
      "Class name: Medavakkam ; No. of Images: 2\n",
