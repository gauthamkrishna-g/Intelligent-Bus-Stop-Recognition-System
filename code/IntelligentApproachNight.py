...
def get_one_image(class_name, rand_num):
    rand_num=rand_num[0]
    if class_name == 1:
        return image_resize(plt.imread("./TestDataNight/Medavakkam/Test" + str(rand_num) + ".jpg")).flatten()
    if class_name == 2:
        return image_resize(plt.imread("./TestDataNight/Mogappair East/Test" + str(rand_num) + ".jpg")).flatten()
    if class_name == 3:
        return image_resize(plt.imread("./TestDataNight/Pari Salai/Test" + str(rand_num) + ".jpg")).flatten()
